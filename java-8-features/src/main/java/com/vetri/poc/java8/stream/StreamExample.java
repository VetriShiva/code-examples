package com.vetri.poc.java8.stream;
...
//        orderOfOperations();
    ...
    private static void findFirstExample() {
        ...
        phoneList
                .stream()
                .sorted(Comparator.comparingInt(Phone::getPrice).reversed())
                .findFirst()
                .ifPresent(System.out::println);
    }
    ...
    private static void mathOperationsExample() {
        ...
        // find max price
        phoneList.stream().mapToInt(p->p.getPrice()).max().ifPresent(System.out::println);
        // mapInt to List
        ...
        System.out.println("Sum : "+prices.stream().mapToInt(x->x).sum());
        System.out.println("Avg : "+prices.stream().mapToInt(x->x).average().getAsDouble());

        System.out.println("Stats : "+prices.stream()
    ...
    private static void orderOfOperations() {
        //1st case.
        System.out.println(">>>>>>>>>> 1st case - map > filter > foreach");
        ...
        //2nd case.
        System.out.println(">>>>>>>>>> 2nd case - filter > map > foreach");
        Stream.of("d2", "a2", "b1", "b3", "c")
                .filter(s -> {
                    System.out.println("filter: " + s);
                    return s.startsWith("a");
        ...
        //3rd case.
        System.out.println(">>>>>>>>>> 3rd case - sorted > filter > map > foreach");
        Stream.of("d2", "a2", "b1", "b3", "c")
                .sorted((s1, s2) -> {
